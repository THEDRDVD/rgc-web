...
<html>
	<head>
		<title>Rebel Gamers Clan - Error 403</title>
		<meta charset="utf-8" />
		<meta name="description" content="Página de Error 403 de Rebel Gamers Clan">
	...
	<body>
		...
		<div id="cuerpo_pagina">
			<section id="zona_principal">
				<div class="notificacion_error"><b>ERROR 403</b>: Usuario no autorizado, tu culo ha sido denegado.</div>
			</section>
