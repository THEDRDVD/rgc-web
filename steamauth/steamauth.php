...
function logoutbutton() {
    echo "<form action=\"steamauth/logout.php\" method=\"post\"><button class=\"boton_normal\" value=\"Logout\" type=\"submit\" title=\"Deja de utilizar la cuenta de Steam que estés usando para la sesión actual. Puedes volver a conectarte en cualquier momento.\"><b style=\"margin: 10px;\">Desconectarse</b></button></form>"; //logout button
}
